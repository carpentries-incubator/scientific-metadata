...
| ----- | :---: | ------------------------------- |
| 35 min | [0](#episode-0-housekeeping) | The lesson starts with an introduction by the instructors, and i.a. the hosting organization, to the learners to the instructors. The learners introduce themselves to briefly and report on their first impressions of the example data object. Scope and schedule of the lesson are outlined. |
| 80 min | [2](#episode-2-data-metadata) | The learners get an introduction into data and metadata in everyday life and research contexts. Descriptive, administrative, and structural metadata are distinguished. The learners conduct a guided online search (URLs are provided) and explore the metadata tagging in selected web pages. Good (enough) and worst practices of metadata annotation will be covered in the fina talk of this module. The presentation is complemented with a live demonstration, collaboratively extracting metadata from scientific publications. |
| 105 min | [3](#episode-3-structured-metadata---from-markup-to-json) | This episode introduces the concept of semi-structured metadata in regards to machine accessibility and interoperability. After defining the term "Markup", the learners will be confronted with XML and JSON as data exchance formats. In the challenges 2 & 3, the learners will apply the lecture content to the example data object by extracting metadata from an accompanying Readme file and annotating the example data object in a JSON object literal. Challenges will be tackled in groups of 5 - 7 learners. Group results are compared and discussed in a plenary discussion. Ideally, the learners will experience light frustration during result comparison, realizing, that structuring their metadata will result in valid machine interpretable data objects, yet lack of comparability and reusability. |
| 20 min | [0](#episode-0-housekeeping-1) | Day 1 concludes with a brief recap on the topics of the first day. Feedback is gathered from the learners and eventually implemented in day 2. An outlook on the contet of the second day is presented. |
</div>
</div>
<div class="overview card">
...
|<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-clock" aria-hidden="true"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg> | Episode | Description |
| ----- | :---: | ------------------------------- |
| 15 min | [0](#episode-0-housekeeping-2) | The learners get a brief recap of the contents of day 1 and an outlook on day 2. In the warm-up session, the learners actively apply their knowledge acquired on day 1 by completing a personal JSON template. |
| 120 min | [4](#episode-4.-enabling-technologies-with-schemas-and-standards) |  |
| 55 min | [5](#episode-5-web-location-identifiers) |  |
| xx min | [6](#episode-6-outlook---linked-data) |  |
...
| 5 min | **Lecture** | [Annotating the example data](#accordionInstructor29) |
| 15 min |  | :coffee: Break :coffee: |
...
<ul>
  ...
  <li>The learners navigate online terminology restries. </li>
</ul>
...
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: instructor
## Lecture: Annotating the example data
