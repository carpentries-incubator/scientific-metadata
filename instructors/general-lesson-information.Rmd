...
(<i>Additional information for instructors is written in italics</i>)
...
This lesson was designed for a heterogenous group of learners from diverse research areas. Hence we decided to use a dataset, that is unlikely to appear in the scientific context, yet has the possibility to be applied as such.<br>
...
**Example dataset:** <a href="../files/exampleDataObject.csv"> exampleDataObject.csv</a>
...
In our 2 day approach, we end at lunch time on the second day, which allows for extra time for discussions with the speaker. The lightning talk so far got great feedback from the learners.
