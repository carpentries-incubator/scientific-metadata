...
Also included in the Instructor guide, you can find `Talking points` for your lecture content. These sections contain the slide numbers for the [accompanying slide set](LINK). Of course you are free to use your own slides and take our Talking point as a guide line.
...
- This is a point you need to consider 
- use this example to bridge to the next topic
- this is important to know for the learners in order to tackle the challenges
