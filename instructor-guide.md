...
8. Let's briefly reflect on the types of metadata, that we came across so far, before we apply these concepts in the first challenge for today: 
  ...
  - administrative metadata specifies how a resource is managed. This can be terms of distribution and copyright information. Regarding published data, this also applies to technical information on the files included in a dataset or versioning...
  - structural metadata describe, for example chapters in a book, file in a dataset, or software components.
...
4. But as soon as you open the underlying datasets, understanding the process on how this data was acquired is not so straight forward anymore. The variables might be hard to understand, there might be missing values, and the data cleaning is not necessarily apparent.
