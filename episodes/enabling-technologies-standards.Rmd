...
<ul>
  ...
  <li><a href="../../../episodes/files/customerInformationForm_solution.json" target="_blank">customerInformationForm_solution.json</a></li>
</ul>
...
<ul>
  ...
  <li>Open the image of the customer information form and an empty JSON file in **split-screen view**. (example */insert link to screenshot/*)</li>
...
<ul>
  ...
  <li> highlight the following aspects: </li>
    <ul>
      ...
      <li>*/@SG: come up with a better number value/*</li>
...
**Challenge type:** group activity, exploration
...
<ul>
  ...
  <li>Inspect the form interface thoroughly, enter some values and discuss the following questions</li>
    <ul>
