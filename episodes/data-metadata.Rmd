...
**White board:** [example set-up](files/example-challenge1-whiteboard.pdf)
...
- **Scientific meta information** is often recorded in handwritten (lab) notes, README style records, or the like, limiting its accessibility.
