...
Press.](fig/jeffreyPomerantzQuote.png){alt="Quote by Monya Baker saying 'Data is stuff. It is raw, unprocessed, possibly even untouched by human hands, unviewed by human eyes,, un-thought-about by human minds.'"}
<br>
...
Although metadata is data itself, it can only exist in connection with a
...
[^2]: Zhang, A. B., Gourley, D. (2008). "Metadata strategy" in Creating
    Digital Collections. Sawston, UK: Woodhead Publishing.
...
licence and intellectual property rights). [^3]

[^3]: Zhang, A. B., Gourley, D. (2008). "Metadata strategy" in Creating
    Digital Collections. Sawston, UK: Woodhead Publishing.
...
chapters in a book). [^4]

[^4]: Zhang, A. B., Gourley, D. (2008). "Metadata strategy" in Creating
    Digital Collections. Sawston, UK: Woodhead Publishing.
...
store and share these information. Often, handwritten lab notes do not
...
[^5]: Chadwick, I. (2016). "Research Data Management: guide to
    writing"readme" type metadata." The Open University.
    <https://www.open.ac.uk/library-research-support/sites/www.open.ac.uk.library-research-support/files/files/RDM-Guidelines-for-creating-readme-style-metadata.pdf>
...
-   **Scientific meta information** is often recorded in handwritten
    (lab) notes, README style records, or the like, limiting its
    accessibility to humans and computers.
:::
