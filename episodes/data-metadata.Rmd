...
**[Slide set](../files/slideSet/1_WhatIsData_CarpentriesIncubator_ScientificMetadata.pdf){target="_blank"}**
...
**[Slide set](../files/slideSet/2_TheExampleDataObject_CarpentriesIncubator_ScientificMetadata.pdf){target="_blank"}**
...
![Information pyramid from glyphs to wisdom highlighting the data fracture. Text reads: Data is potential information and needs to be processed and contextualized to make it accessible for the human audience.](fig/informationPyramid.png){target="_blank"}
...
**[Slide set](../files/slideSet/3_WhatIsMetadata_CarpentriesIncubator_ScientificMetadata.pdf){target="_blank"}**
...
**[Slide set](../files/slideSet/4_DescriptiveAdministrativeStructuralMetadata_CarpentriesIncubator_ScientificMetadata.pdf){target="_blank"}**
...
**[Slide set](../files/slideSet/5_Challenge1RealWorldMetadata_CarpentriesIncubator_ScientificMetadata.pdf){target="_blank"}**
...
**[Slide set](../files/slideSet/6_MetadataInScience_CarpentriesIncubator_ScientificMetadata.pdf){target="_blank"}**: 
...
**[this template](https://cornell.app.box.com/v/ReadmeTemplate){target="_blank"}**
for readme-style metadata documents.
